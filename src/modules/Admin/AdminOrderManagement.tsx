...
const AdminOrderManagement: React.FC = () => {
  ...
  const handleUpdateStatus = async (values: any) => {
    try {
      ...
      await adminService.updateOrderStatus(editingOrder.id, updateData);
            ...
            <Descriptions title="Thông tin đơn hàng" bordered column={2}>
              ...
              <Descriptions.Item label="Trạng thái">
                <Tag color={getStatusColor(orderDetail.order_status)}>
                  {getStatusLabel(orderDetail.order_status)}
                </Tag>
              </Descriptions.Item>
              ...
              <Descriptions.Item label="Phí vận chuyển">
                {orderDetail.shipping_fee.toLocaleString('vi-VN')} VNĐ
              </Descriptions.Item>
